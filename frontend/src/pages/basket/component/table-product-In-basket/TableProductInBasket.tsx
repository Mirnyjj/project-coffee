...
const TableProductInBasketContainer = ({className}: Props) => {
                            ...
                            (product) => (
                                <div key={product.id} className="table-row">
                                        <div className="box1" onClick={() => 
                                                    {setBasket(
                                                        deleteProductBasket(basketUp, product.id, 0)
                                                        )}
                                                    }
                                        >
                                            <Icon 
                                        ...
                                        <div className="box6">{Number(product.price) * product.amount} ₽</div>
